...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating,
    calculateNoOfLectures,calculateCourseDuration,calculateChapterTime,currency
  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10'>
        ...
        text-course-deatails-heading-small font-semibold text-black-500'>{courseData.courseTitle}</h1>
