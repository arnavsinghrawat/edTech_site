          ...
          <div className='flex md:flex-row flex-col items-center gap-3'>
            ...
            <label htmlFor="thumbnailImage" className='flex items-center gap-3'>
              ...
              <input 
                ...
                hidden
              />
              {image && <img src={URL.createObjectURL(image)} alt="Preview" className='h-12' />}
            </label>
          </div>
        </div>
                  ...
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lecture.lectureId} className='flex justify-between items-center mb-2'>
                      <span>
                        ...
                        - <a href={lecture.lectureUrl} className='text-blue-500' target='_blank' rel="noopener noreferrer">
                          Link
                        </a>
